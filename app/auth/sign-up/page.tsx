...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : "Có lỗi đã diễn ra")
    } finally {
      setIsLoading(false)
    }
  }
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      if (error) throw error
      // Supabase sẽ tự redirect sang Google
    } catch (error: unknown) {
      setError(
        error instanceof Error ? error.message : "Không thể đăng ký bằng Google"
      )
